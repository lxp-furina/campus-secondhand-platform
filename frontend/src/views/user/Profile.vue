<template>
  <div class="page profile">
    ...
    <el-card>
      <h2>修改密码</h2>
      <el-form ref="pwdRef" :model="password" :rules="rules" label-width="90px">
        <el-form-item label="旧密码" prop="oldPassword"><el-input v-model="password.oldPassword" type="password" show-password /></el-form-item>
